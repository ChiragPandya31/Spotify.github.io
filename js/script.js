...
//Below function is used to convert seconds to minutes
...
async function getSongs(folder) {
  ...
  let response;
  let a = await fetch(`${folder}`).then(async (a) => {
...
async function main() {
  ...
  //Add an event Listener for time update event
